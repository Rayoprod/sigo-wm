  ...
  async guardar() {
    ...
    try {
      ...
      const pedidoData = {
          ...
          direccion_entrega_detalle: (this.lugar_entrega === 'OBRA' || (this.direccion_entrega_detalle && this.direccion_entrega_detalle.trim().length > 0)) ? this.direccion_entrega_detalle : null,
          lat_destino: (this.lugar_entrega === 'OBRA' || this.lat_destino != null) ? this.lat_destino : null,
          lng_destino: (this.lugar_entrega === 'OBRA' || this.lng_destino != null) ? this.lng_destino : null,
